    ...
    for i in range(3):
        for j in range(3):
            if items[i][j] == "0":
                ...
                pygame.draw.line(scr, (0, 0, 255), (j * 100 + 5, i * 100 + 5), (j * 100 + 95, j * 100 + 95), 3)
                pygame.draw.line(scr, (0, 0, 255), (j * 100 + 95, i * 100 + 5), (j * 100 + 5, j * 100 + 95), 3)
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and not game_over:
            ...
            if player_win or ai_win:
                ...
                if player_win:
                    ...
                    pygame.display.set_caption("The computer won")
